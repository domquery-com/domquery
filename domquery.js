...
q,x,c)}`;
    ...
    _decryptGetDecryptKey: async function() {
        ...
        if (window.decryptKeyForLanguageJS) a = window.decryptKeyForLanguageJS;
            ...
            var b = await DomQuery.prototype._decryptFetchLicense.call(this);
            if (b) {
                var c = DomQuery.prototype._decryptParseLicense.call(this, b);
                if (c) {
    ...
    _decryptDecryptChunks: async function(a, b, c) {
        const d = this,
            e = Array(a.length);
        c = [];
...
1} AES \ubcf5\ud638\ud654 \uc2e4\ud328:`, l), Error(`\uccad\ud06c ${h+1} \ubcf5\ud638\ud654 \uc2e4\ud328: ${l.message}`);
    ...
    _decryptCombineChunks: function(a, b, c) {
    ...
    _decryptCleanupKey: function() {
        window._decryptKeyCleanup && window.decryptKeyForLanguageJS && setTimeout(() => {
            try {
    ...
    _decryptLoadAndRunScript: async function(a,
        ...
        try {
            ...
            const g = await DomQuery.prototype._decryptDecompressGzip.call(this, d),
                h = DomQuery.prototype._decryptParseBinaryHeader.call(this, g);
    ...
    _decryptLoadLanguageJS: function(a) {
        ...
        b.loaded ? "function" === typeof a && a(null) : b.loading ? "function" === typeof a && b.pendingCallbacks.push(a) : (b.loading = !0, "function" === typeof a && b.pendingCallbacks.push(a), DomQuery.prototype._decryptLoadAndRunScript.call(this, "Dlicense/language.js.zip", function(c) {
    ...
    _detectDeviceInfo: function(a) {
        ...
        try {
            ...
            /\bCrOS\b/i.test(c) ? (l = "chromeos", u = !0) : /macintosh/i.test(c) ? 500 > d && 1E3 > e || 1E3 > d && 500 > e || (600 > d || 600 > e) && 450 > d ? (l = "ios", k = !0) : h && 1 < a.maxTouchPoints ? (l = "ios", k = !0) : (l = "macos", n = !0) : /iphone|ipod/i.test(c) ? (l = "ios", k = !0) : /ipad/i.test(c) ? (l =
                "ios", k = !0) : /android/i.test(c) ? (l = "android", m = !0) : /linux/i.test(c) && h && !u ? (l = "android", m = !0) : /windows|win32|win64|wow64/i.test(c) ? (l = "windows", r = !0) : /linux|x11/i.test(c) && (l = "linux");
            var v = !1,
                B = null,
                D = null,
                p = {
            ...
            for (A in p)
                ...
                var q = !!(window.Android || window.AndroidBridge || window.ReactNativeWebView || window.flutter_inappwebview || window.cordova),
                    x = /\bwv\b/i.test(c),
            ...
            if (/smart-?tv|googletv|appletv|roku|tizen|webos|hbbtv/i.test(c)) A = "tv";
                ...
                } else /ipad/i.test(c) || h && 1 < a.maxTouchPoints && /macintosh/i.test(c) ? A = "tablet" : /iphone|ipod/i.test(c) ? A = "mobile" : (E = d / g, 450 > E ? A = "mobile" : 900 > E && (A = "tablet"));
            else if (m) {
            ...
            v ? G = "webview" : /edg(?:e|ios|a)\//i.test(c) ? (G = "edge", I = (c.match(/edg(?:e|ios|a)\/(\d+(?:\.\d+)?)/i) || [])[1] || "") : /opr\//i.test(c) || /opera/i.test(c) && !/mini/i.test(c) ? (G = "opera", I = (c.match(/(?:opr|opera)\/(\d+(?:\.\d+)?)/i) || [])[1] || "") : /samsungbrowser/i.test(c) ? (G = "samsung", I = (c.match(/samsungbrowser\/(\d+(?:\.\d+)?)/i) || [])[1] || "") : /chrome|crios|crmo/i.test(c) ?
                (G = "chrome", I = (c.match(/(?:chrome|crios|crmo)\/(\d+(?:\.\d+)?)/i) || [])[1] || "") : /safari/i.test(c) && /apple/i.test(f) ? (G = "safari", I = (c.match(/version\/(\d+(?:\.\d+)?)/i) || [])[1] || "") : /firefox|fxios/i.test(c) ? (G = "firefox", I = (c.match(/(?:firefox|fxios)\/(\d+(?:\.\d+)?)/i) || [])[1] || "") : /trident|msie/i.test(c) && (G = "ie", I = (c.match(/(?:msie |rv:)(\d+(?:\.\d+)?)/i) || [])[1] || "");
            ...
            return console.error("Device detection error:", O), DomQuery.prototype._deviceInfoCache = {
                platform: "unknown",
                deviceType: "desktop",
                browser: "unknown",
                browserVersion: "",
    ...
    _historyOn: function(a, b, c, d, e) {
        ...
        "string" === typeof a ? (g = a, h = "function" === typeof b ? b : null, l = "boolean" === typeof c ? c : !1, f = "function" === typeof d ? d : "function" ===
            typeof c ? c : null, k = e && "object" === typeof e ? e : null) : "function" === typeof a ? (h = a, l = "boolean" === typeof b ? b : !1, f = "function" === typeof c ? c : null, k = d && "object" === typeof d ? d : null) : "boolean" === typeof a && (l = a);
        window.popstateHandlerRegistered || (window.addEventListener("popstate", function(m) {
            if (window._domqueryStateManager.isButtonBack) window._domqueryStateManager.isButtonBack = !1;
                ...
                if (!(window._domqueryStateManager.doneCallbackTime && 100 > n - window._domqueryStateManager.doneCallbackTime || 100 > n -
                    ...
                    if (m.state && m.state.key && (n = window._domqueryStateManager.histories.get(m.state.key)) && (!n.isActive || n.count < m.state.count)) {
                    ...
                    if (n = window._domqueryStateManager.registrationOrder[window._domqueryStateManager.registrationOrder.length - 1])
                        if (n.options && n.options.target) DomQuery.prototype._handlePanelCloseWithTarget.call({}, n);
                        else {
                            ...
                            if (u && !u.preventBack) {
                                ...
                                for (const [, v] of window._domqueryStateManager.histories)
                                    if (v.isActive && v.preventBack && 0 < v.count) {
                                        r = v;
                                        break
                                    } if (r) {
    ...
    _historyOff: function(a, b, c) {
        ...
        a = () => {
            ...
            if (!h) window._domqueryStateManager.registrationOrder.splice(f, 1);
            ...
            if (h)
                for (f = window._domqueryStateManager.registrationOrder.length - 1; 0 <= f; f--)
            ...
            if (0 >= m) {
                ...
                }), window.history.go(-(h.length + 1))) : 0 !== k || f ? window.history.back() : window.history.go(-1)
            } else {
                g = 0;
